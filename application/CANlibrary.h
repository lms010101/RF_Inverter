...
/*CAN
extern unsigned char TXMsgData[8], RXMsgData[8];
...
//extern void myIinitCAN();
extern void myGettingCANMSG();
//extern tCANMsgObject sTXCANMessage;  //CAN Transfer
//extern tCANMsgObject sRXCANMessage;  //CAN Receive
#endif CAN_LIB_
*/
