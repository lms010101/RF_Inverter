...
/*** PIE Vect Table and Boot ROM Variables Structures ***/
  UNION run = PIE_VECT, PAGE = 1
   ...
   AdcaResultFile        : > ADCA_RESULT,  PAGE = 1, ALIGN(4)
   AdcbResultFile        : > ADCB_RESULT,  PAGE = 1, ALIGN(4)
   AdccResultFile        : > ADCC_RESULT,  PAGE = 1, ALIGN(4)
   AdcdResultFile        : > ADCD_RESULT,  PAGE = 1, ALIGN(4)

   AdcaRegsFile          : > ADCA,         PAGE = 1, ALIGN(4)
   AdcbRegsFile          : > ADCB,         PAGE = 1, ALIGN(4)
   AdccRegsFile          : > ADCC,         PAGE = 1, ALIGN(4)
   AdcdRegsFile          : > ADCD,         PAGE = 1, ALIGN(4)

   AnalogSubsysRegsFile  : > ANALOG_SUBSYS, PAGE = 1, ALIGN(4)

   CanaRegsFile          : > CANA,         PAGE = 1, ALIGN(4)
   CanbRegsFile          : > CANB,         PAGE = 1, ALIGN(4)

   Cla1RegsFile          : > CLA1,         PAGE = 1, ALIGN(4)
   Cla1SoftIntRegsFile   : > PIE_CTRL,     PAGE = 1, type=DSECT

   ClbXbarRegsFile       : > CLB_XBAR     PAGE = 1, ALIGN(4)

   Cmpss1RegsFile        : > CMPSS1,      PAGE = 1, ALIGN(4)
   Cmpss2RegsFile        : > CMPSS2,      PAGE = 1, ALIGN(4)
   Cmpss3RegsFile        : > CMPSS3,      PAGE = 1, ALIGN(4)
   Cmpss4RegsFile        : > CMPSS4,      PAGE = 1, ALIGN(4)
   Cmpss5RegsFile        : > CMPSS5,      PAGE = 1, ALIGN(4)
   Cmpss6RegsFile        : > CMPSS6,      PAGE = 1, ALIGN(4)
   Cmpss7RegsFile        : > CMPSS7,      PAGE = 1, ALIGN(4)
   Cmpss8RegsFile        : > CMPSS8,      PAGE = 1, ALIGN(4)

   CpuTimer0RegsFile     : > CPU_TIMER0,    PAGE = 1, ALIGN(4)
   CpuTimer1RegsFile     : > CPU_TIMER1,    PAGE = 1, ALIGN(4)
   CpuTimer2RegsFile     : > CPU_TIMER2,    PAGE = 1, ALIGN(4)

   DacaRegsFile          : > DACA          PAGE = 1, ALIGN(4)
   DacbRegsFile          : > DACB          PAGE = 1, ALIGN(4)
   DaccRegsFile          : > DACC          PAGE = 1, ALIGN(4)

   DcsmZ1RegsFile        : > DCSM_Z1,          PAGE = 1, ALIGN(4)
   DcsmZ2RegsFile        : > DCSM_Z2,          PAGE = 1, ALIGN(4)
   DcsmCommonRegsFile    : > DCSM_COMMON,      PAGE = 1, ALIGN(4)

   DmaRegsFile           : > DMA           PAGE = 1, ALIGN(4)
   DmaClaSrcSelRegsFile  : > DMACLASRCSEL  PAGE = 1, ALIGN(4)

   ECap1RegsFile         : > ECAP1,        PAGE = 1, ALIGN(4)
   ECap2RegsFile         : > ECAP2,        PAGE = 1, ALIGN(4)
   ECap3RegsFile         : > ECAP3,        PAGE = 1, ALIGN(4)
   ECap4RegsFile         : > ECAP4,        PAGE = 1, ALIGN(4)
   ECap5RegsFile         : > ECAP5,        PAGE = 1, ALIGN(4)
   ECap6RegsFile         : > ECAP6,        PAGE = 1, ALIGN(4)

   Emif1RegsFile         : > EMIF1         PAGE = 1, ALIGN(4)
   Emif2RegsFile         : > EMIF2         PAGE = 1, ALIGN(4)

   EPwm1RegsFile         : > EPWM1,        PAGE = 1, ALIGN(4)
   EPwm2RegsFile         : > EPWM2,        PAGE = 1, ALIGN(4)
   EPwm3RegsFile         : > EPWM3,        PAGE = 1, ALIGN(4)
   EPwm4RegsFile         : > EPWM4,        PAGE = 1, ALIGN(4)
   EPwm5RegsFile         : > EPWM5,        PAGE = 1, ALIGN(4)
   EPwm6RegsFile         : > EPWM6,        PAGE = 1, ALIGN(4)
   EPwm7RegsFile         : > EPWM7,        PAGE = 1, ALIGN(4)
   EPwm8RegsFile         : > EPWM8,        PAGE = 1, ALIGN(4)
   EPwm9RegsFile         : > EPWM9,        PAGE = 1, ALIGN(4)
   EPwm10RegsFile        : > EPWM10,       PAGE = 1, ALIGN(4)
   EPwm11RegsFile        : > EPWM11,       PAGE = 1, ALIGN(4)
   EPwm12RegsFile        : > EPWM12,       PAGE = 1, ALIGN(4)

   EPwmXbarRegsFile      : > EPWM_XBAR     PAGE = 1, ALIGN(4)

   EQep1RegsFile         : > EQEP1,        PAGE = 1, ALIGN(4)
   EQep2RegsFile         : > EQEP2,        PAGE = 1, ALIGN(4)
   EQep3RegsFile         : > EQEP3,        PAGE = 1, ALIGN(4)

   Flash0CtrlRegsFile     : > FLASH0_CTRL    PAGE = 1, ALIGN(4)
   Flash0EccRegsFile      : > FLASH0_ECC     PAGE = 1, ALIGN(4)
   Flash1CtrlRegsFile     : > FLASH1_CTRL    PAGE = 1, ALIGN(4)
   Flash1EccRegsFile      : > FLASH1_ECC     PAGE = 1, ALIGN(4)

   GpioCtrlRegsFile      : > GPIOCTRL,     PAGE = 1, ALIGN(4)
   GpioDataRegsFile      : > GPIODAT,      PAGE = 1, ALIGN(4)

   OutputXbarRegsFile    : > OUTPUT_XBAR    PAGE = 1, ALIGN(4)
   I2caRegsFile          : > I2CA,          PAGE = 1, ALIGN(4)
   I2cbRegsFile          : > I2CB,          PAGE = 1, ALIGN(4)
   InputXbarRegsFile     : > INPUT_XBAR     PAGE = 1, ALIGN(4)
   XbarRegsFile          : > XBAR           PAGE = 1, ALIGN(4)

   FlashPumpSemaphoreRegsFile   : > FLASHPUMPSEMAPHORE,    PAGE = 1, ALIGN(4)

   RomPrefetchRegsFile       : > ROMPREFETCH,       PAGE = 1, ALIGN(4)
   MemCfgRegsFile            : > MEMCFG,            PAGE = 1, ALIGN(4)
   Emif1ConfigRegsFile       : > EMIF1CONFIG,       PAGE = 1, ALIGN(4)
   Emif2ConfigRegsFile       : > EMIF2CONFIG,       PAGE = 1, ALIGN(4)
   AccessProtectionRegsFile  : > ACCESSPROTECTION,  PAGE = 1, ALIGN(4)
   MemoryErrorRegsFile       : > MEMORYERROR,       PAGE = 1, ALIGN(4)
   RomWaitStateRegsFile      : > ROMWAITSTATE,      PAGE = 1, ALIGN(4)

   McbspaRegsFile        : > MCBSPA,       PAGE = 1, ALIGN(4)
   McbspbRegsFile        : > MCBSPB,       PAGE = 1, ALIGN(4)

   UppRegsFile           : > UPP,          PAGE = 1, ALIGN(4)

   NmiIntruptRegsFile    : > NMIINTRUPT,   PAGE = 1, ALIGN(4)
   PieCtrlRegsFile       : > PIE_CTRL,     PAGE = 1, ALIGN(4)

   SciaRegsFile          : > SCIA,         PAGE = 1, ALIGN(4)
   ScibRegsFile          : > SCIB,         PAGE = 1, ALIGN(4)
   ScicRegsFile          : > SCIC,         PAGE = 1, ALIGN(4)
   ScidRegsFile          : > SCID,         PAGE = 1, ALIGN(4)

   Sdfm1RegsFile         : > SDFM1,        PAGE = 1, ALIGN(4)
   Sdfm2RegsFile         : > SDFM2,        PAGE = 1, ALIGN(4)

   SpiaRegsFile          : > SPIA,        PAGE = 1, ALIGN(4)
   SpibRegsFile          : > SPIB,        PAGE = 1, ALIGN(4)
   SpicRegsFile          : > SPIC,        PAGE = 1, ALIGN(4)
   SpidRegsFile          : > SPID,        PAGE = 1, ALIGN(4)

   DevCfgRegsFile        : > DEV_CFG,     PAGE = 1, ALIGN(4)
   ClkCfgRegsFile        : > CLK_CFG,     PAGE = 1, ALIGN(4)
   CpuSysRegsFile        : > CPU_SYS,     PAGE = 1, ALIGN(4)

   SyncSocRegsFile       : > SYNC_SOC,    PAGE = 1, ALIGN(4)

   WdRegsFile            : > WD,           PAGE = 1, ALIGN(4)

   XintRegsFile          : > XINT          PAGE = 1, ALIGN(4)
   MemCfgRegs            : > MEMCFG        PAGE = 1, ALIGN(4)
